...
Given our protein-coding reads, we could now use reduced amino acid alphabets as a lightweight substitute for homology across species.
...
Instead, we found that even protein $k$-mers cannot reliably identify cell types across species. We turned to reduced amino acid alphabets such as dayhoff (Fig. {@fig:fig2}A).
