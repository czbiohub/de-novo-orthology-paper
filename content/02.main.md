...
We demonstrate the utility of this method by combining a single-cell atlas of mouse, a model organism, *Tabula Muris Senis*, with bulk RNA-seq from *Botryllus schlosseri*, a colonial tunicate which exhibits cell populations similar to the myeloid immune lineage.
We show that the cells

From the shared cell types, we can
