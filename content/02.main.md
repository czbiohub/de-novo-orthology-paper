...
We found that by searching for the number of k-mers overlapping the query cell, using `sourmash search --containment`, we were able to correctly identify the cell type ---% of the time (Fig. {@fig:fig2}B).
