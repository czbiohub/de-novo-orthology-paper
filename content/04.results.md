...
### Figure 2 -- $k$-mers from lossily-encoded putative protein-coding reads faithfully represent transcriptomes within amniotes
...
### Figure 3 -- $k$-mers can compare short and long read datasets in primate brain organoids
...
### Figure 4 -- long evolutionary distances with HP encoding?
